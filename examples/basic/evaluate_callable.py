"""Code-first evaluation — assess a retrieval pipeline in pure Python (no YAML).

Run:  python examples/basic/evaluate_callable.py
"""
...
if __name__ == "__main__":
    ...
    report = ro.evaluate(
        ...
        corpus=CORPUS,
        k=5,
        db_path=".retobs/evaluate_callable.db",
    )
    report.show()
    ...
    print("Open the dashboard with:  retobs serve --db .retobs/evaluate_callable.db")
