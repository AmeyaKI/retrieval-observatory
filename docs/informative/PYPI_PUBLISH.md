...
```bash
curl -sf "https://pypi.org/pypi/retrieval-observatory/0.5.1/json" | python3 -c "import sys,json; print(json.load(sys.stdin)['info']['version'])"

pip install "retrieval-observatory[dashboard]==0.5.1"
