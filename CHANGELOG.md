...
- `retobs compare --artifacts DIR` writes `release-audit.json` and `release-audit.html` before the exit status is decided; `examples/ci/release-policy-demo-v3.yaml` (resolves on the demo database).
