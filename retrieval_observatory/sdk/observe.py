...
def start_trace(ctx: ObserveContext, *, metadata: Dict[str, Any] | None = None) -> RetrievalTraceV2:
    ...
    *,
    ...
    def decorator(fn: Callable[..., Any]) -> Callable[..., Any]:
        ...
        async def async_wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            parent_ids = kwargs.pop("parent_ids", None) or ([trace.spans[-1].op_id] if trace and trace.spans else [])
            op_id = kwargs.pop("op_id", None) or f"{op_type.lower()}_{uuid.uuid4().hex[:8]}"
            try:
                ...
                if trace is not None:
                    span = OperatorSpan(
                        ...
                        latency_ms=elapsed,
                        inputs=_to_candidates(kwargs.get("documents") or kwargs.get("docs"), op_id=op_id),
                        outputs=_to_candidates(result, op_id=op_id),
